...
//        self.objectId = videoId;
    ...
    @NSManaged public dynamic var caption: String?;
    @NSManaged public dynamic var numberOfComment: Int
    @NSManaged public dynamic var numberOfView: Int
    @NSManaged public dynamic var numberOfVerifyRequired: Int
    @NSManaged public dynamic var isSuccessVideo: Bool
    @NSManaged public dynamic var thumbNailImage: AVFile!
