//
//  VideoByCategoryViewController.swift
//  Smyt
//
//  Created by Shawn on 6/05/2016.
...
class VideoByCategoryViewController: UIViewController,UITableViewDelegate, UITableViewDataSource, MFMailComposeViewControllerDelegate,HomeVideoTableViewCellProtocol{
    
    @IBOutlet weak var tableView: UITableView!
    
    var videoArray = [CLVideo]();
    var videoItemArray = [AVPlayerItem]();
    var videoQuery : AVQuery!;
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        NSLog("video by category VC appeared");
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        NSLog("video by category VC view did appear");
    }
